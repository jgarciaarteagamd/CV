  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <section className="bg-slate-900 p-8 rounded-2xl shadow-xl text-white">
        ...
        <form className="space-y-4" action={`https://formsubmit.co/${data.contact.email}`} method="POST">
          ...
          ></textarea>
          <button type="submit" className="w-full sm:w-auto bg-indigo-500 hover:bg-indigo-600 px-6 py-3 rounded-lg text-xs font-bold transition-colors">
